"""ORM table definitions (database schema).

These map to SQL tables. Domain/API shapes live in `app.models` (Pydantic).
Repositories translate between the two — never expose ORM rows to routes.
"""
